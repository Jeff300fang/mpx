...
initial_height = 0.29  # Initial height of the robot's base in meters
robot_height = 0.29  # Height of the robot's base in meters
...
Qp    = jnp.diag(jnp.array([0, 0, 3e4]))  # Cost matrix for position
