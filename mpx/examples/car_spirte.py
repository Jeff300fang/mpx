...
def main():
    ...
    obstacles = jnp.array([[1.0, 0.4, 0.2], [2.0, -0.4, 0.2], [4.0, -0.2, 0.2], [0.8, -0.6, 0.2],
                           ...
                           [13.0, -0.4, 0.2], [11.0, -1.0, 0.2], [16.0, -0.7, 0.2], [17.5, -0.7, 0.2], [18, 1.0, 0.2], [13.7, -1.0, 0.2], [7.0, -0.5, 0.2],
                           [5.7, -1.1, 0.2], [10.0, 0.9, 0.2], [7.5, -1.1, 0.2],
                           [5.0, 1.2, 0.2], [10.2, -.9, 0.2], [11.4, 1.3, 0.2],
...
def save_mpc_rollout_npz(
    ...
    """
    Save MPC rollout + SLS data to a single NPZ file.

    Arrays are saved exactly as produced by the solver.
    """
    np.savez(
        filename,
