...
def main():
    ...
    obstacles = jnp.array([[1.0, 0.4, 0.2], [2.0, -0.4, 0.2], [4.0, -0.2, 0.2], [0.8, -0.6, 0.2],
                           ...
                           [6.0, 0.0, 0.2], [9.0, 1.0, 0.2], [8.0, 1.5, 0.2], [6.2, 1.4, 0.2],
                           [12.0, 0.4, 0.2], [11.0, 0.6, 0.2], [13.0, 1.0, 0.2], [15.0, 1.3, 0.2], [16.0, 1.4, 0.2],
                           [8.0, -0.5, 0.2], [9.2, -1.2, 0.2], [1.3, -1.4, 0.2], [2.9, -1.0, 0.2], [4.1, -1.2, 0.2], [14.5, -0.2, 0.2],
                           [13.0, -0.4, 0.2], [11.0, -1.0, 0.2], [16.0, -0.7, 0.2], [17.5, -0.7, 0.2]])
